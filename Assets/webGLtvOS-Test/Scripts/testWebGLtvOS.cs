...
public class testWebGLtvOS : MonoBehaviour
{
    ...
    IEnumerator zipNativeBuffer() {
        ...
        // Here we are calling the coroutine for a pointer. We also get the downloaded file size.
         StartCoroutine(lzip.downloadZipFileNative("https://dl.dropboxusercontent.com/s/xve34ldz3pqvmh1/testZip.zip", r => downloadDone4 = r, null, pointerResult => nativePointer = pointerResult, size => zipSize = size));
        ...
        StartCoroutine(lzip.downloadZipFileNative("https://dl.dropboxusercontent.com/s/xve34ldz3pqvmh1/testZip.zip", r => downloadDone4 = r, result => inMemZip = result));
